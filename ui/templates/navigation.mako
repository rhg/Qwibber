        ...
        % if item["account"]:
          <div class="account"
            ...
            <div class="stream"
                ...
                <img class="icon" title="${item['service']} (${item['name']})" src="${service_icon(item['service'])}" />
            ...
            <div class="streams">
              % for stream in item["items"]:
                <div class="stream"
                  ...
                  <img class="icon" title="${item['service']} (${item['name']}) - ${stream['name']}" src="${icon(stream['stream'])}" />
                  % if stream["transient"]:
                    <img class="closebutton" transient="${stream['transient']}" src="${util.icon('gtk-close')}" />
                  % endif
